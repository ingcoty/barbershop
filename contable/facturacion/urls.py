...
urlpatterns = [
    ...
    path('productos/frmproductos/<int:id>',
         formproductos, name='frmproductos'),
    ...
    path('unidades/eliminar/<int:id>/',
         eliminarunidades, name='eliminarunidades'),
    ...
    path('tipoterceros/frmtipoterceros/',
         newformtipoterceros, name='newformtipoterceros'),
    path('tipoterceros/frmtipoterceros/<int:id>',
         formtipoterceros, name='formtipoterceros'),
    path('tipoterceros/tbltipoterceros/',
         tbltipoterceros, name='tbltipoterceros'),
    path('tipoterceros/savetipoterceros/',
         savetipoterceros, name='savetipoterceros'),
    path('tipoterceros/editar/<int:id>/',
         editartipoterceros, name='editartipoterceros'),
    path('tipoterceros/eliminar/<int:id>',
         eliminartipoterceros, name='eliminartipoterceros'),

    path('tipocontribuyente/', tipocontribuyente, name='tipocontribuyente'),
    path('tipocontribuyente/frmtipocontribuyente/',
         newformtipocontribuyente, name='newformtipocontribuyente'),
    path('tipocontribuyente/frmtipocontribuyente/<int:id>',
         formtipocontribuyente, name='formtipocontribuyente'),
    path('tipocontribuyente/tbltipocontribuyente/',
         tbltipocontribuyente, name='tbltipocontribuyente'),
    path('tipocontribuyente/savetipocontribuyente/',
         savetipocontribuyente, name='savetipocontribuyente'),
    path('tipocontribuyente/editar/<int:id>/',
         editartipocontribuyente, name='editartipocontribuyente'),
    path('tipocontribuyente/eliminar/<int:id>',
         eliminartipocontribuyente, name='eliminartipocontribuyente'),
    ...
    path('facturas/tblfacturascompras',
         tblfacturascompras, name='tblfacturascompras'),
    ...
    path('inventario/frminvetariodetalle/<int:num>',
         frminvetariodetalle, name='frmdetalle'),
    path('inventario/tbldetalle/<int:num>/<str:inicial>/<str:final>',
         tblinventariodetalle, name='tblinventariodetalle'),
    ...
    path('reportes/tblRptInventario/<str:inicial>/<str:final>',
         tblRptInventario, name='tblrptinventario'),
    path('reportes/tblRptVentas/<str:inicial>/<str:final>',
         tblRptVentas, name='tblrptventas'),

    path('reportes/kardex', rptkardex, name='kardex'),
    path('reportes/tblRptKardex/<str:inicial>/<str:final>/<int:codproduct>',
         tblRptKardex, name='tblrptkardex'),

    path('reportes/dowloadinventario/<str:inicial>/<str:final>',
         download_inventario, name='dowload_rptInventario'),
    path('reportes/dowloadventas/<str:inicial>/<str:final>',
         download_ventas, name='dowload_rptVentas'),
    path('reportes/dowloadkardex/<str:inicial>/<str:final>/<int:codproduct>',
         download_kardex, name='dowload_rptKardex'),
